...
<!--Chart-box-->    
    <div class="row-fluid">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Edit Fasilitas Wisata</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="<?php echo base_url().'variabel_fasilitas/update_fasilitas'?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="fasilitas" value="<?php echo $fasilitas; ?>" class="span11"/>
              </div>
            </div>
