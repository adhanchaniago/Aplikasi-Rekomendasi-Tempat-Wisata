...
<!--Chart-box-->    
    <div class="row-fluid">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo base_url().'variabel_jarak/simpan_jarak'?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="jarak" class="span11" placeholder="Jarak Wisata" />
              </div>
            </div>
