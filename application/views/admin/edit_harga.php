...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Edit Harga Wisata</a></div>
  </div>
<!--End-breadcrumbs-->
...
<!--Chart-box-->    
    <div class="row-fluid">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Edit Harga Wisata</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="<?php echo base_url().'variabel_harga/update_harga'?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="harga" value="<?php echo $harga; ?>" class="span11"/>
              </div>
            </div>
