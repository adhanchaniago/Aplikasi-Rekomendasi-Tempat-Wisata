...
<!--Chart-box-->    
    <div class="row-fluid">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo base_url().'variabel_harga/simpan_harga'?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="harga" class="span11" placeholder="Harga Wisata" />
              </div>
            </div>
