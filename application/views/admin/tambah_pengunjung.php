...
<!--Chart-box-->    
    <div class="row-fluid">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo base_url().'variabel_pengunjung/simpan_pengunjung'?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="pengunjung" class="span11" placeholder="Pengunjung Wisata" />
              </div>
            </div>
