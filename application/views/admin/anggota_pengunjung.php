        ...
        <div class="span8">
            <div class="widget-box">
              <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                <h5>Derajat Keanggotaan Pengunjung</h5>
              </div>
              <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                  ...
                  <tbody>
                    <?php $no = 0; foreach($derajat_anggota_pengunjung as $row) 
                    { $no++;
                    ?>
                    <tr>
                        <td><?php echo $no; ?></td>
                        ...
                        <td><?php echo $row['sepi']; ?></td>
                        <td><?php echo $row['biasa']; ?></td>
                        <td><?php echo $row['ramai']; ?></td>
                    </tr>
                    <?php 
                    } ?>
                  </tbody>
