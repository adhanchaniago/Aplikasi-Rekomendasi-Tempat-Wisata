...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="row-fluid">
        <a href="<?php echo base_url(); ?>admin/tambah_wisata"><button class="btn btn-info">Tambah</button></a>
    </div>
                ...
                <table class="table table-bordered data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>admin/detail_wisata/<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="DETAIL">
                                <i class="icon-eye-open"></i>
                            </a>
                            <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>admin/edit_wisata/<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                <i class="icon-edit"></i>
                            </a>
                            <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/hapus_wisata/<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="HAPUS">
