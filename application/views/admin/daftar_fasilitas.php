            ...
            <div class="widget-box">
              ...
              <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                  ...
                  <tbody>
                    <?php $no = 0; foreach($daftar_fasilitas as $row) 
                    { $no++;
                    ?>
                    <tr>
                        <td><?php echo $no; ?></td>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>variabel_fasilitas/edit_fasilitas/<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                <i class="icon-edit"></i>
                            </a>
                        </td>
                    </tr>
