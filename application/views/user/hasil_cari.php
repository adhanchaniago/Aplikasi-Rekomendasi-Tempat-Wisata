    ...
    <div class="colorlib-wrap">
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <div class="row">
              <h3 style="text-align: center;">Hasil Daftar Wisata Pencarian Anda</h3>
              <div class="wrap-division">
                <?php
                if(!empty($hasil_cari))
                { 
                    $no = 0; foreach($hasil_cari as $row) 
                    { 
                    ?>
                      <div class="col-md-6 col-sm-6 animate-box">
                        <div class="hotel-entry">
                          <a href="<?php echo base_url(); ?>beranda/detail_wisata/<?php echo $row['id_wisata']; ?>" class="hotel-img">
                            <img src="<?php echo base_url(); ?><?php echo $row['foto']; ?>" class="hotel-img" width="100%">
                            <p class="price"><span>Tiket Masuk Rp <?php echo $row['harga']; ?></span></p>
                          </a>
                          <div class="desc">
                            <p class="star"> <?php echo $row['pengunjung']; ?> Total Pengunjung</p>
                            <h3><a href="hotel-room.html"><?php echo $row['nama']; ?></a></h3>
                      ...
                      <div class="col-md-6 col-sm-6 animate-box">
                        <div class="hotel-entry">
                          <div class="desc">
                            <center><h4><i>"Wisata Tidak Ditemukan"</h4></i></center>
